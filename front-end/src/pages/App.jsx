...
function App() {
  ...
  const buscaNoticia = async (municipio) => {
    ...
    if (municipio === "Rio de Janeiro") {
      response = await fetch("https://www.legnet.com.br:5000/api/noticias3")
    } else if (municipio === "São Paulo") {
      response = await fetch("https://www.legnet.com.br:5000/api/noticias5")
    } else if (municipio === "Porto Alegre") {
      response = await fetch("https://www.legnet.com.br:5000/api/noticias4")
    }
  ...
  const buscaObrigacao = async () => {
    const response = await fetch('https://www.legnet.com.br:5000/api/requisitoObrigacao')
